...
/*
void PR2adaptNeuroControllerClass::setDataPoint(dataPoint::Datum* datum, double & dt)
{
	datum->set_dt                 (  dt                          );
...
Eigen::MatrixXd
PR2adaptNeuroControllerClass::JointVelKdl2Eigen( KDL::JntArrayVel & joint_ )
{
...
KDL::JntArray
PR2adaptNeuroControllerClass::JointEigen2Kdl( Eigen::VectorXd & joint )
{
