#include "uta_pr2_forceControl/impedanceController.h"
#include <pluginlib/class_list_macros.h>

using namespace pr2_controller_ns;

/// Controller initialization in non-realtime
bool PR2ImpedanceControllerClass::init( pr2_mechanism_model::RobotState *robot, ros::NodeHandle &n )
{
...
//PR2ImpedanceControllerClass::SystemVector
//PR2ImpedanceControllerClass::JointKdl2Eigen( KDL::JntArray & joint_ )
//{
//	SystemVector joint;
//	joint(0) = joint_(0);
//	joint(1) = joint_(1);
...
//
//PR2ImpedanceControllerClass::SystemVector
//PR2ImpedanceControllerClass::JointVelKdl2Eigen( KDL::JntArrayVel & joint_ )
//{
//	SystemVector joint;
...
//
//KDL::JntArray
//PR2ImpedanceControllerClass::JointEigen2Kdl( SystemVector & joint )
//{
//	KDL::JntArray joint_;
//	joint_.resize(7);
//
...
//}
//
//Eigen::Matrix<double, PR2ImpedanceControllerClass::Hidden, 1>
//PR2ImpedanceControllerClass::sigmoid( Eigen::Matrix<double, Hidden, 1> & z )
//{
...
PLUGINLIB_REGISTER_CLASS( PR2ImpedanceControllerClass,
						  pr2_controller_ns::PR2ImpedanceControllerClass,
